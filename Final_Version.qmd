...
ggplot() + geom_sf(data = world_map, fill = NA, colour = "green")+ geom_sf(data = volcanomap_data)
...
ggplot() + geom_sf(aes(geometry = world_map\$geometry))+ geom_sf(data = world_map, fill = NA, colour = "blue") + geom_sf(data = volcanomap_data, colour = "red")
